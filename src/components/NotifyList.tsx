...
function kindBadge(kind: string) {
  if (kind === "like") {
    return (
      <div
        className={`inline-flex items-center px-3 py-1 rounded-full gap-x-2 bg-purple-100/60`}
      >
  ...
  if (kind === "pull request") {
    return (
      <div
        className={`inline-flex items-center px-3 py-1 rounded-full gap-x-2 bg-pink-100/60`}
      >
  ...
  return (
    <div>
      <section className="container px-4 mx-auto">
        <div className="mx-3 font-bold text-xl text-gray-600">通知</div>
